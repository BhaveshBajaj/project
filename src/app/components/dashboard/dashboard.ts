...
import { BlogCardComponent } from '../shared/blog-card/blog-card';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, HeaderComponent, CourseCardComponent, BlogCardComponent],
...
export class DashboardComponent implements OnInit {
  ...
  private loadUserData(userId: number): void {
    ...
    this.courseService.getLastViewedCourses(userId).subscribe(courses => {
      this.lastViewedCourses = courses;
    });

    // Load newly launched courses
    this.courseService.getNewlyLaunchedCourses().subscribe(courses => {
